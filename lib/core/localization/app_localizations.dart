...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'ar': {
      ...
      'invalidRoomCode': 'كود الغرفة يجب أن يكون من 5 أو 6 رموز من الأحرف A-Z بدون I و O، والأرقام من 2 إلى 9 بدون 0 و1.',
    ...
    'en': {
      ...
      'invalidRoomCode': 'Room code must be 5 or 6 characters using A-Z without I or O, and digits 2-9 without 0 or 1.',
