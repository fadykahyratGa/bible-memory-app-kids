...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'ar': {
      ...
      'invalidRoomCode': 'كود الغرفة يجب أن يكون من 5 أو 6 رموز من الأحرف A-Z أو الأرقام 2-9.',
    ...
    'en': {
      ...
      'invalidRoomCode': 'Room code must be 5 or 6 characters using A-Z and digits 2-9.',
