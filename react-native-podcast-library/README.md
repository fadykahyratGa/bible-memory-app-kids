...
6. Deploy a refresh edge function at `/functions/v1/scrape-refresh` (used by scheduler).
...
- Scheduler support included: scraper refresh runs every 12 hours (00:00 and 12:00 UTC).
